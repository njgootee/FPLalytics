...
for fixture_id in new_fixture_ids:
    ...
    #add team xg data
    new_player_data = new_player_data.merge(fixture_data[['fixture_id', 'h_xg', 'a_xg']], on='fixture_id')
    new_player_data['team_xG'] = np.where(new_player_data['h_a']=='h', new_player_data['h_xg'], new_player_data['a_xg'])
    #adjust dtypes
